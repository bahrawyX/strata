...
export const DEMO_ROWS: RowsByTable = {
  users: [
    { id: "e7a1-2c", email: "alex.chen@arcadia.dev", name: "Alex Chen", status: "active", plan: "team", tags: ["beta", "founder"], metadata: { source: "referral", referrer: "twitter" }, created_at: "2024-02-14 09:21" },
    { id: "3f9b-71", email: "m.kowalski@hyperflow.io", name: "Marta Kowalski", status: "active", plan: "pro", tags: ["beta"], metadata: { source: "organic" }, created_at: "2024-03-02 14:08" },
    { id: "a014-d8", email: "d.osei@founderhq.co", name: "Darius Osei", status: "active", plan: "team", tags: [], metadata: {}, created_at: "2024-03-19 06:55" },
    { id: "b2c4-05", email: "priya.r@northbeam.app", name: "Priya Ramanathan", status: "active", plan: "pro", tags: ["bay-area"], metadata: { source: "demo-day" }, created_at: "2024-04-01 11:42" },
    { id: "5d8e-ff", email: "j.iwasaki@kintai.jp", name: "Junji Iwasaki", status: "active", plan: "free", tags: null, metadata: null, created_at: "2024-04-12 18:30" },
    { id: "9f01-3a", email: "samira.b@orbitline.eu", name: "Samira Beltrán", status: "active", plan: "pro", tags: ["eu", "beta"], metadata: { source: "organic", region: "eu-west" }, created_at: "2024-04-23 02:11" },
    { id: "21bd-8c", email: "t.ofori@bridgeway.dev", name: "Tomi Ofori", status: "active", plan: "team", tags: ["africa"], metadata: { source: "referral" }, created_at: "2024-05-08 22:04" },
    { id: "cc77-12", email: "noor.h@arcboard.io", name: "Noor Hadid", status: "active", plan: "pro", tags: ["beta"], metadata: { source: "organic" }, created_at: "2024-05-19 07:26" },
  ],
  orders: [
  ...
  products: [
    { id: "prd-001", sku: "STR-NEON-12", name: "Neon Strata Plan", price_cents: 4_900, price_display: "$49.00", in_stock: true },
    { id: "prd-002", sku: "STR-TEAM-12", name: "Team Plan", price_cents: 12_900, price_display: "$129.00", in_stock: true },
    { id: "prd-003", sku: "STR-ENT-12", name: "Enterprise Plan", price_cents: 99_900, price_display: "$999.00", in_stock: true },
    { id: "prd-004", sku: "STR-FREE-00", name: "Free Plan", price_cents: 0, price_display: "$0.00", in_stock: true },
  ],
  sessions: [
    { id: "ses-aa11", user_id: "e7a1-2c", ip: "203.0.113.42", user_agent: "Mozilla/5.0 (Macintosh)", ttl: "24 hours", created_at: "2024-05-19 09:01" },
    { id: "ses-bb22", user_id: "3f9b-71", ip: "203.0.113.18", user_agent: "Mozilla/5.0 (Windows)", ttl: "12 hours", created_at: "2024-05-19 09:14" },
    { id: "ses-cc33", user_id: "a014-d8", ip: null, user_agent: null, ttl: null, created_at: "2024-05-19 09:38" },
  ],
  invoices: [
